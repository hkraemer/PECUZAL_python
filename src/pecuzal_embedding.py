...
def pecuzal_embedding(s, taus = range(50), theiler = 1, sample_size = 1., K = 13, KNN = 3, Tw_factor = 4, alpha = 0.05, p = 0.5, max_cycles = 50):
    ...
    .. [1] Kraemer et al., "A unified and automated approach to attractor reconstruction", arXiv, vol. 22,
        pp. 585-588, 2020.
    .. [2] Pecora et al., "A unified approach to attractor reconstruction", Chaos, vol. 17, 013110, 2007.  https://doi.org/10.1063/1.2430294
...
def continuity_statistic(s, taus, js, delays = range(50), sample_size = 1.0, K = 13, theiler = 1, norm = 'euclidean', alpha = 0.05, p = 0.5):
    ...
    Notes
    -----
    The full algorithm is too large to discuss here and written in detail in [1]_ and in summary in [2]_.

    References
    ----------
    .. [1] Pecora et al., "A unified approach to attractor reconstruction", Chaos, vol. 17, 013110, 2007. https://doi.org/10.1063/1.2430294
