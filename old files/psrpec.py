...
# =============================================================================
# def embed_pecora_uzal(var,taus=0:50, datasample=0.5,theiler_window=1,...
#                       alpha=0.05,p=0.5,norm='euclidean'):
#     function_body
# =============================================================================
...
# statistic, `p` is the probability for the binomial distribution and `norm` is
# the metric for distance computations. This can be restricted to `euclidean` and
# `chebychev`.     
